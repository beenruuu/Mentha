    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-gray-50 dark:from-black dark:to-gray-900">
      <div className="max-w-2xl text-center p-8">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link href="/settings" className="inline-block border border-gray-200 dark:border-[#2A2A30] px-6 py-3 rounded-lg text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-[#0A0A0A]">Configuración</Link>
        </div>
      </div>
    </div>
  )
