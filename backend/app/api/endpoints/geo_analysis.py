...
from app.tasks.geo_analysis_tasks import run_full_geo_analysis_task
...
async def run_geo_analysis(
    ...
    The analysis runs asynchronously via Celery. Poll the status endpoint for results.
    """
    # Get Supabase client
    ...
    run_full_geo_analysis_task.delay(
