...
export const analyzeBrandVisibilitySchema = z.object({
    ...
    engine: z
        ...
        .optional()
        .describe('Which AI engine to query. Default: openai'),
...
export const createBrandEntitySchema = z.object({
    ...
    disambiguating_description: z
        .string()
        .optional()
        .describe('What the brand is NOT (to prevent AI confusion)'),
    same_as: z
        .array(z.string())
        .optional()
        .describe('Official links: GitHub, LinkedIn, Twitter, Wikipedia'),
});
