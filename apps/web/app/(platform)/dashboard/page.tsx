...
export default function Home() {
    ...
    return (
        ...
        >
            ...
            {/* 2. Visibility Chart */}
            <div
                className="chart-section minimal"
            ...
            <div className="cards-row">
                <div className="card">
                    <div className="card-header">
                        ...
                        <span
                            className="metric-dot dot-blue"
                            style={{ background: '#10b982' }}
                        ></span>
                    </div>
                ...
                <div className="card">
                    ...
                    <div className="score-content">
                        <div className="score-circle">
                            ...
                            <div className="score-value" style={{ color: '#10b982' }}>
                                {summary?.visibilityRate || 0}%
                            </div>
                        </div>
                        <div className="score-info">
                            <span className="score-label">
                                {summary?.visibilityRate > 50 ? 'Optimized' : 'Improving'}
                            </span>
                            <span className="score-description">
                                Based on {summary?.totalScans || 0} recent scans across AI models.
                            </span>
                        </div>
                    </div>
                </div>
                                    ...
                                    >
                                        <span
                                            style={{
                                                ...
                                                transform: expandedKeywords.has(kw.id)
                                                    ? 'rotate(90deg)'
                                                    : 'none',
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    Latest AI Response (
                                                    {kw.latestResult.scan_jobs?.engine})
                                                </span>
                                                <span
                                                    style={{
                                                        fontSize: '10px',
                                                ...
                                                >
                                                    ...
                                                    <strong
                                                        style={{
                                                            color:
                                                                kw.latestResult.sentiment_score > 0
                                                                    ? 'var(--green)'
                                                                    : 'var(--red)',
                                                        }}
                                                    >
                                                        {kw.latestResult.sentiment_score}
                                                    </strong>
                                                </span>
                                            </div>
                                            <p
                                            ...
                                            >
                                                {kw.latestResult.analysis_json?.summary ||
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                <div className="card" style={{ height: '320px' }}>
                    ...
                    <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '12px' }}>
                        AI sentiment score from -1 (Negative) to 1 (Positive)
                    </p>
                </div>
                ...
                <div className="card">
                    <div className="card-header">
                        ...
                        <span
                            className="metric-dot dot-green"
                            style={{ background: '#10b982' }}
                        ></span>
                    </div>
                    <div className="table-content" style={{ marginTop: '16px' }}>
                        {dashboardData?.byEngine
                            ? Object.entries(dashboardData.byEngine).map(
                                  ([engine, stats]: [string, any]) => {
                                      const isOpenAI = engine.toLowerCase().includes('openai');
                                      const displayName = isOpenAI
                                          ? 'OpenAI'
            ...
            <div className="table-section">
                <div className="card-header">
                    ...
                    <button className="card-link" onClick={() => setSelectedScan(null)}>
                        Latest Activity
                    </button>
                </div>
                <div className="table-content">
                                ...
                                <div style={{ textAlign: 'right' }}>
                                    <span
                                        style={{
                                            ...
                                            fontSize: '10px',
                                            fontWeight: 'bold',
                                            background: scan.brand_visibility
                                                ? 'rgba(52, 211, 153, 0.1)'
                                                : 'rgba(248, 113, 113, 0.1)',
                                            color: scan.brand_visibility
                                                ? 'var(--green)'
                                                : 'var(--red)',
                                        }}
                                    >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            <div>
                                ...
                                <p style={{ margin: 0, fontWeight: 600 }}>
                                    {selectedScan.scan_jobs?.keywords?.query}
                                </p>
                            </div>
                            <div>
                                <p
