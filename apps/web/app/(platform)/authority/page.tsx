...
export default function AuthorityPage() {
    ...
    const [citationData, setCitationData] = useState<{ data: any[]; raw: any[] }>({
        data: [],
        raw: [],
    });
    ...
    return (
        ...
        >
            ...
            <section className="metrics-grid">
                ...
                <div className="metric-card">
                    <div className="metric-header">
                        <span className="metric-label">Brand Presence</span>
                        <span className="metric-dot dot-purple"></span>
                    </div>
                    <div className="metric-value">
                        {Math.round(
                            (aggregated.filter((c) => c.isBrand).length /
                                (aggregated.length || 1)) *
                                100,
                        )}
                        %
            ...
            <div
                ...
                style={{ display: 'grid', gridTemplateColumns: '1.5fr 2.5fr', gap: '24px' }}
            >
                {/* Domains Sidebar */}
                ...
                <section className="table-section">
                    <div className="card-header">
                        ...
                        <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
                            Citations provided by AI engines
                        </span>
                    </div>
