                    ...
                    return (
                        <div key={`item-${index}`} className="flex items-center gap-2">
                            {isAvgVisibility ? (
                                ...
                                <div className="flex h-5 w-5 items-center justify-center rounded bg-mentha-forest/10 dark:bg-mentha-mint/10">
                            ...
                            content={({ active, payload, label }) => {
                                ...
                                return (
                                    <div className="bg-mentha-forest dark:bg-mentha-dark border border-mentha-mint/20 rounded-xl p-3 backdrop-blur-lg shadow-xl">
                                        <div className="text-xs text-mentha-muted font-bold mb-2 font-mono">
                                            {label}
                                        </div>
                                            ...
                                            return (
                                                ...
                                                >
                                                    {isAvgVisibility ? (
                                                        ...
                                                        <div className="flex items-center justify-center w-4 h-4 bg-mentha-mint/10 rounded">
                                                            <EngineIcon
...
function CustomDot(props: any) {
    ...
    return (
        <foreignObject x={cx - 6} y={cy - 6} width={12} height={12}>
            <div className="flex items-center justify-center w-full h-full bg-white dark:bg-mentha-dark rounded-full shadow-sm ring-1 ring-black/5">
