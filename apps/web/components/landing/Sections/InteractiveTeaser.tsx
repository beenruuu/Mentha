...
const InteractiveTeaser: React.FC = () => {
  ...
  return (
    <section id="audit" className="border-b border-mentha-forest dark:border-mentha-beige py-24 px-6 relative overflow-hidden">
      <div className="max-w-3xl mx-auto relative z-10">
        <div className="text-center mb-12">
            <span className="font-mono text-xs text-mentha-mint border border-mentha-forest dark:border-mentha-beige px-2 py-1 rounded-full">LIVE DEMO</span>
            <h2 className="font-serif text-5xl mt-6 mb-4">How does AI see you right now?</h2>
            <p className="font-sans opacity-70">Simulate a real-time GEO query using Gemini 1.5.</p>
        </div>
            ...
            <form onSubmit={handleAnalyze} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <label className="font-mono text-xs uppercase tracking-widest ml-1">Your Brand</label>
                        <input 
                            type="text" 
                            value={brand}
                    ...
                    <div className="space-y-2">
                         <label className="font-mono text-xs uppercase tracking-widest ml-1">Product / Category</label>
                        <input 
                            type="text" 
                            value={category}
                ...
                <div className="flex justify-end pt-4">
                    ...
                    >
                        ...
                        <span>{loading ? 'ANALYZING NEURAL PATHS...' : 'RUN DIAGNOSTIC'}</span>
                    </button>
                </div>
            </form>
        </div>
        ...
        {result && (
            <div className="mt-8 border border-mentha-forest dark:border-mentha-beige p-6 md:p-8 bg-mentha-mint bg-opacity-5 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex justify-between items-start border-b border-mentha-forest dark:border-mentha-beige border-opacity-20 pb-4 mb-6">
                    <h3 className="font-mono text-sm uppercase text-mentha-mint">Audit Report: {brand}</h3>
                    <span className="font-mono text-xs opacity-60">Generated via Gemini</span>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    <div>
                        <p className="font-mono text-[10px] uppercase opacity-60 mb-2">Visibility Score</p>
                        <div className="text-4xl font-serif">{result.visibilityScore}/100</div>
                    </div>
                    <div>
                        <p className="font-mono text-[10px] uppercase opacity-60 mb-2">Sentiment</p>
                        <div className="text-xl font-sans font-medium">{result.sentiment}</div>
                    </div>
                    <div>
                        <p className="font-mono text-[10px] uppercase opacity-60 mb-2">Top Association</p>
                        <div className="text-xl font-serif italic text-mentha-mint">"{result.topAssociation}"</div>
                    </div>
                </div>

                <div className="space-y-6">
                    <div>
                         <p className="font-mono text-[10px] uppercase opacity-60 mb-2">Simulated LLM Response</p>
                     ...
                     <div className="pt-4 border-t border-mentha-forest dark:border-mentha-beige border-opacity-20">
                         <p className="font-mono text-[10px] uppercase text-mentha-mint mb-2">Strategic Recommendation</p>
