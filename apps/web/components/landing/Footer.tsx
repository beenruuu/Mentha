            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                    <div className="col-span-1 md:col-span-1">
                        <Link
                            href="/"
                            className="text-xl font-medium tracking-tight uppercase mb-6 block font-sans"
                        >
                            Mentha
                        </Link>
                        <p className="text-gray-500 dark:text-gray-400 font-light text-sm leading-relaxed max-w-xs">
                            The first open-source platform dedicated specifically to Answer Engine
                            Optimization.
                        </p>
                    </div>

                    <div>
                        <h4 className="text-xs font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-6 font-sans">
                            Product
                        </h4>
                        <ul className="space-y-4">
                            ...
                            <li>
                                <NavLink href="/authority">Authority</NavLink>
                            </li>
                        </ul>
                    </div>
...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
    return (
        <Link
            href={href}
            className="text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors text-sm font-light"
        >
            {children}
        </Link>
    );
