            ...
            <div className="self-stretch px-6 md:px-24 py-6 md:py-10 flex justify-center items-center gap-6 relative z-10">
                ...
                <div className="w-full max-w-[586px] px-6 py-5 md:py-8 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-6 relative z-20">
                    <div className="self-stretch flex flex-col justify-start items-start gap-4">
                        ...
                        <div className="self-stretch text-center text-zinc-500 dark:text-zinc-400 text-lg leading-7 font-light">
                            {t.ctaDescription}
                        </div>
                    </div>
                    <div className="w-full max-w-[497px] flex flex-col justify-center items-center gap-12">
                        <div className="flex justify-start items-center gap-4">
                            <Link
                                href="/auth/signup"
                                className="h-12 px-8 py-3 relative bg-zinc-950 dark:bg-white text-white dark:text-black shadow-sm overflow-hidden rounded-full flex justify-center items-center cursor-pointer hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors"
                            >
