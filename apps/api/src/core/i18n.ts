...
const dictionary: Record<string, Record<Language, string>> = {
    ...
    'menu.monitoring.run_scan': {
        es: '🔎  EJECUTAR SCAN (Tiempo Real)',
        en: '🔎  RUN SCAN NOW (Real-time)',
    },
    'menu.monitoring.view_results': {
        es: '📊  Ver Últimos Resultados',
        en: '📊  View Latest Results',
    },
    'menu.kg.title': {
        es: '🧠 KNOWLEDGE GRAPH (Optimización AEO):',
        en: '🧠 KNOWLEDGE GRAPH (AEO Optimization):',
    },
    'menu.kg.entities': {
        es: '🏢  Gestionar Entidades (Identidad)',
        en: '🏢  Manage Entities (Identity)',
    },
    ...
    'menu.eeat.title': {
        es: '⭐ E-E-A-T (Autoridad y Confianza):',
        en: '⭐ E-E-A-T (Authority & Trust):',
    },
    'menu.eeat.authors': { es: '👤  Gestionar Autores/Expertos', en: '👤  Manage Authors/Experts' },
    'menu.eeat.clusters': {
        es: '📚  Clusters de Contenido (Autoridad Tópica)',
        en: '📚  Content Clusters (Topical Authority)',
    },
    'menu.eeat.reviews': { es: '⭐  Añadir Ratings/Reviews', en: '⭐  Add Ratings/Reviews' },
    'menu.settings.title': { es: '⚙️ CONFIGURACIÓN:', en: '⚙️ SETTINGS:' },
    'menu.settings.select_project': {
        es: '📂  Seleccionar/Cambiar Proyecto Activo',
        en: '📂  Select/Switch Active Project',
    },
    'menu.settings.create_project': {
        es: '➕  Crear Nuevo Proyecto',
        en: '➕  Create New Project',
    },
    'menu.settings.change_engine': {
        es: '🤖  Cambiar Motor IA (Defecto: OpenAI)',
        en: '🤖  Change AI Engine (Default: OpenAI)',
    },
    'menu.settings.delete_project': {
        es: '🗑️  Borrar Proyecto (Zona de Peligro)',
        en: '🗑️  Delete Project (Danger Zone)',
    },
