...
const YourWorkInSync: React.FC<YourWorkInSyncProps> = ({
  ...
  const themeVars =
    theme === "light"
      ? {
          "--yws-surface": "#ffffff",
          "--yws-text-primary": "#000000",
          "--yws-text-secondary": "#6b7280",
          "--yws-bubble-light": "#f3f4f6",
          "--yws-bubble-dark": "#10b981", // Mentha green
      ...
      : ({
          ...
          "--yws-bubble-dark": "#059669", // Mentha green dark
          "--yws-bubble-white": "#ffffff",
      ...
      >
        ...
        <div style={{ width: "356px", height: "216px", position: "relative", transform: "scale(1.1)" }}>
          ...
          >
            ...
            <div
              style={{
                background: theme === "light" ? "#f3f4f6" : "var(--yws-bubble-light)",
                borderRadius: "999px",
                padding: "0px 12px",
                height: "36px",
                display: "flex",
            ...
            >
              <span
                style={{
                  ...
                  lineHeight: "16px",
                  letterSpacing: "-0.4px",
                  color: theme === "light" ? "#000000" : "var(--yws-text-primary)",
                  whiteSpace: "nowrap",
                }}
              >
          ...
          >
            ...
            <div
              style={{
                background: theme === "light" ? "#10b981" : "var(--yws-bubble-dark)",
                borderRadius: "999px",
                padding: "0px 12px",
                height: "36px",
                display: "flex",
