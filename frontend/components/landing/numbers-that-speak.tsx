...
const NumbersThatSpeak: React.FC<NumbersThatSpeakProps> = ({
  ...
  const themeVars =
    theme === "light"
      ? {
          "--nts-surface": "#ffffff",
          "--nts-text-primary": "#000000",
          "--nts-text-secondary": "rgba(0,0,0,0.8)",
          "--nts-text-muted": "rgba(0,0,0,0.7)",
          "--nts-border": "rgba(0,0,0,0.12)",
          "--nts-shadow": "rgba(0,0,0,0.06)",
        }
      : ({
          "--nts-surface": "#1f2937",
          "--nts-text-primary": "#ffffff",
          "--nts-text-secondary": "rgba(255,255,255,0.8)",
          "--nts-text-muted": "rgba(255,255,255,0.7)",
          "--nts-border": "rgba(255,255,255,0.12)",
          "--nts-shadow": "rgba(0,0,0,0.24)",
          ...
          <div>
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0px 0px 0px 0.587px rgba(0,0,0,0.12), 0px 1.174px 2.348px -0.587px rgba(0,0,0,0.06), 0px 1.761px 3.522px -0.88px rgba(0,0,0,0.06)",
          ...
          <div>
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0px 0px 0px 0.717px rgba(0,0,0,0.12), 0px 1.435px 2.87px -0.717px rgba(0,0,0,0.06), 0px 2.152px 4.304px -1.076px rgba(0,0,0,0.06)",
                maskImage: `url('${imgSchedule}')`,
          ...
          <div>
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0px 0px 0px 0.783px rgba(0,0,0,0.12), 0px 1.565px 3.13px -0.783px rgba(0,0,0,0.06), 0px 2.348px 4.696px -1.174px rgba(0,0,0,0.06)",
                maskImage: `url('${imgSchedule}')`,
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {[
                                { height: "83px", color: "#10b981" },
                                { height: "108px", color: "#10b981" },
                                { height: "58px", color: "#10b981" },
                                { height: "89px", color: "#10b981" },
                                { height: "83px", color: "#10b981" },
                                { height: "89px", color: "#10b981" },
                                { height: "83px", color: "#10b981" },
                                { height: "95px", color: "#10b981" },
                                { height: "108px", color: "#10b981" },
                                { height: "76px", color: "#10b981" },
                                { height: "89px", color: "#10b981" },
                              ].map((item, index) => (
                                <div
                                  key={index}
