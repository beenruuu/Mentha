...
import { MessageSquare, Sparkles, AlertTriangle, Menu } from "lucide-react"
...
export function PromptsChat({ brandId, brandName, brandDomain }: PromptsChatProps) {
    ...
    return (
        <div className="flex h-full max-h-[calc(100vh-12rem)] bg-background">
            {/* Desktop Sidebar */}
            <div className="hidden md:block w-64 shrink-0 h-full border-r border-border/40">
                <PromptsSidebar
                    brandId={brandId}
            ...
            {/* Main Chat Area */}
            <div className="flex flex-col flex-1 h-full min-w-0 bg-background/50 relative">
                {/* Header / Disclaimer */}
                ...
                <div className="flex-1 overflow-y-auto px-4 py-6 scroll-smooth">
                    {messages.length === 0 ? (
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-center p-4 animate-in fade-in zoom-in duration-300">
                            ...
                            <p className="text-muted-foreground text-sm max-w-md leading-relaxed mb-8 flex flex-wrap items-center justify-center gap-1">
                                <span>Descubre qué saben realmente</span>
                                ...
                                <span>basándose únicamente en su entrenamiento.</span>
                            </p>
                ...
                <div className="shrink-0 px-4 pb-4 pt-2 bg-gradient-to-t from-background via-background to-transparent z-10 w-full max-w-4xl mx-auto">
                    <PromptsChatInput
