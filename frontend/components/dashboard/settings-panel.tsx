                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-col gap-4">
                          <p className="text-xs text-gray-400 max-w-md leading-relaxed">
                            {t.exportDataDescription || "Descarga una copia de todos tus datos personales en formato JSON."}
                          </p>
                          <Button variant="outline" className="border-white/10 bg-[#111114] text-white hover:bg-white/5 hover:text-white shrink-0 w-fit">
                            ...
                            {t.exportMyData || "Exportar mis datos"}
                          </Button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-6 bg-[#0C0C0E] border border-white/5 rounded-2xl">
                      ...
                      <div className="bg-[#111114] border border-white/5 rounded-xl p-6 relative overflow-hidden group">
                        <div className="flex flex-col gap-4 relative z-10">
                          ...
                          <Button onClick={() => setUpgradeModalOpen(true)} className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-500/20 transition-all hover:scale-105 active:scale-95 whitespace-nowrap w-fit">
                    ...
                    <div>
                      ...
                      <div className="border border-dashed border-white/10 rounded-xl p-12 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-sm text-gray-400">{t.noInvoicesAvailable || "No hay facturas disponibles"}</p>
                      </div>
                    </div>
                  </div>
                )}
