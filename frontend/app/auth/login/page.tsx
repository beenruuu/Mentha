...
export default function LoginPage() {
  ...
  return (
    <div className="w-full">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2 text-foreground">{t.authLogin}</h1>
        <p className="text-muted-foreground">{t.authLoginDescription}</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/auth/forgot" className="text-sm font-medium text-mentha hover:underline">
