...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-white/60 max-w-2xl mx-auto">
            Traditional search is evolving. Understand why optimizing for AI engines requires a completely new approach.
          </p>
        </div>
        
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-[#0b2421]/50 backdrop-blur-sm">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
            {/* Header Column (Hidden on mobile, handled differently) */}
            <div className="hidden md:block p-8 bg-white/5">
              <div className="h-12"></div> {/* Spacer */}
              <div className="space-y-8 mt-8">
                <div className="font-medium text-white/80">Goal</div>
                <div className="font-medium text-white/80">Target Audience</div>
                <div className="font-medium text-white/80">Key Metric</div>
                <div className="font-medium text-white/80">Content Strategy</div>
                <div className="font-medium text-white/80">Technical Focus</div>
              </div>
            </div>
            ...
            <div className="p-8">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-xl font-semibold text-white">Traditional SEO</h3>
              </div>
              
              <div className="space-y-8">
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-white/50 block mb-1">Goal</span>
                  <p className="text-slate-300">Rank #1 on Google Blue Links</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-white/50 block mb-1">Target Audience</span>
                  <p className="text-slate-300">Humans searching for links</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-white/50 block mb-1">Key Metric</span>
                  <p className="text-slate-300">Clicks & Traffic</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-white/50 block mb-1">Content Strategy</span>
                  <p className="text-slate-300">Keywords & Backlinks</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-white/50 block mb-1">Technical Focus</span>
                  <p className="text-slate-300">Core Web Vitals & Meta Tags</p>
                </div>
              </div>
            </div>

            {/* GEO Column */}
            <div className="p-8 bg-emerald-900/10 relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-8">
                <div className="h-10 w-10 rounded-full bg-emerald-500/20 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-400"><path d="M12 2a10 10 0 0 1 7.38 16.75"/><path d="M12 8v8"/><path d="M16 12H8"/></svg>
                </div>
                <h3 className="text-xl font-semibold text-white">Mentha GEO</h3>
              </div>
              
              <div className="space-y-8">
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-emerald-500/50 block mb-1">Goal</span>
                  <p className="text-white font-medium">Be the Cited Answer</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-emerald-500/50 block mb-1">Target Audience</span>
                  <p className="text-white font-medium">LLMs & AI Agents</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-emerald-500/50 block mb-1">Key Metric</span>
                  <p className="text-white font-medium">Share of Voice & Citations</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-emerald-500/50 block mb-1">Content Strategy</span>
                  <p className="text-white font-medium">Entities, Context & Authority</p>
                </div>
                <div>
                  <span className="md:hidden text-xs uppercase tracking-wider text-emerald-500/50 block mb-1">Technical Focus</span>
                  <p className="text-white font-medium">Structured Data & Vector Embeddings</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {[
            {
              step: "01",
              title: "Scan & Analyze",
              desc: "We crawl your site and analyze how AI models perceive your brand entities and content structure."
            },
            {
              step: "02",
              title: "Identify Gaps",
              desc: "Our AI compares your visibility against competitors across ChatGPT, Claude, and Perplexity."
            },
            {
              step: "03",
              title: "Optimize",
              desc: "Get actionable recommendations to restructure content and add data that LLMs love to cite."
            },
            {
              step: "04",
              title: "Track Growth",
              desc: "Monitor your 'Share of Voice' in AI responses and watch your citations grow over time."
            }
          ].map((item, i) => (
            <div key={i} className="relative z-10 flex flex-col items-center text-center group">
              <div className="w-24 h-24 rounded-full bg-[#0b2421] border border-emerald-500/30 flex items-center justify-center mb-6 group-hover:border-emerald-500 transition-colors duration-300 shadow-[0_0_30px_rgba(16,185,129,0.1)]">
      ...
      {/* Use Cases */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white/5 rounded-3xl my-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-white/60 mb-8">
              Whether you're a SaaS platform, an E-commerce giant, or a local business, Mentha helps you control your narrative in the age of AI search.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Ensure ChatGPT recommends your tool when users ask for 'best software for X'. Dominate comparison queries."
                },
                {
                  title: "E-commerce Brands",
                  desc: "Get your products cited in 'top 10' lists generated by Perplexity and Google SGE. Drive high-intent traffic."
                },
                {
                  title: "Enterprise & Corporate",
                  desc: "Manage brand reputation and ensure accurate company information across all major LLMs."
                }
              ].map((useCase, i) => (
                <div key={i} className="flex gap-4">
                  <div className="mt-1 h-6 w-6 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-emerald-500/20 rounded-full blur-3xl opacity-20"></div>
            <div className="relative bg-[#0b2421] border border-white/10 rounded-2xl p-8 shadow-2xl">
              <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
                <div className="h-3 w-3 rounded-full bg-red-500"></div>
                <div className="h-3 w-3 rounded-full bg-yellow-500"></div>
                <div className="h-3 w-3 rounded-full bg-green-500"></div>
                <div className="ml-auto text-xs text-white/40 font-mono">AI Simulation</div>
              </div>
              
              <div className="space-y-4 font-mono text-sm">
                <div className="bg-white/5 p-3 rounded-lg rounded-tl-none">
                  <p className="text-emerald-400 mb-1 text-xs">User Query</p>
                  <p className="text-white">"What is the best tool for AEO optimization?"</p>
                </div>
                
                <div className="bg-emerald-900/20 p-3 rounded-lg rounded-tr-none border border-emerald-500/20">
                  <p className="text-emerald-400 mb-1 text-xs">AI Response</p>
                  <p className="text-slate-300">
                    "Based on current analysis capabilities and feature sets, <span className="text-white font-bold bg-emerald-500/20 px-1 rounded">Mentha</span> is widely considered the leading tool for AEO. It offers specialized features for tracking visibility across LLMs like ChatGPT and Claude..."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="mt-3 grid grid-cols-1 gap-2 text-sm">
                  <Link href="/legal/terms" className="font-medium tracking-tight hover:underline">Terms & Conditions</Link>
                  <Link href="/legal/privacy" className="font-medium tracking-tight hover:underline">Privacy Policy</Link>
                  <Link href="/legal/cookies" className="font-medium tracking-tight hover:underline">Cookie Policy</Link>
                </div>
              </div>
            </div>
