 ...
 * 
 * This component receives initial data from the server and handles all interactivity.
 * The key improvement is that initialBrands, initialBrand, and initialCompetitors
 * are already fetched - no loading spinner needed for first render.
 */
export function DashboardClient({
    ...
    // Initialize state with server-provided data (no initial loading!)
    ...
    // Loading is false by default now! We have initial data.
    ...
    // Fetch additional data (chart data, visibility) for a brand
    // This is still needed for updates, period changes, etc.
    ...
    // Note: We still need this for chart/visibility data which isn't fetched on server
    useEffect(() => {
        if (selectedBrand) {
    ...
    // Initial load of chart data for the initial brand
    useEffect(() => {
        if (initialBrand) {
            ...
            <SidebarInset className="bg-[#FAFAFA] dark:bg-[#09090b] h-screen overflow-hidden flex flex-col">
                ...
                <header className="flex items-center justify-between px-6 py-4 shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        {/* No loading spinner for initial brand - we have data from server! */}
                            ...
                            <div className="lg:col-span-2 space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {(viewingCompetitor
                                        ...
                                        <button
                                            key={comp.id}
                                            onClick={() => !viewingCompetitor && setViewingCompetitor(comp)}
