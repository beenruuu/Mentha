...
import { useAdminData, type AdminDataProps } from '../hooks/useAdminData'

const COLORS = ['#10b981', '#8b5cf6', '#f59e0b', '#ec4899', '#06b6d4']

export function AdminClient(props: AdminDataProps) {
                                ...
                                <Card className="border-0 shadow-sm">
                                    ...
                                    <CardContent>
                                        <div className="space-y-4">
                                            {userAnalytics?.geography.slice(0, 5).map((geo) => (
